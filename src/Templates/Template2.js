    ...
    <Paper
      ...
      <Container>
        <div className='temponegrid'>
          <div>
            <Heading color={"#8000ff"} title={"Professional Experience"} />
          ...
          <div>
            <Heading color={"#8000ff"} title={"Education"} />
            <EducationTemp education={educationinfo} />
          </div>
          <div>
            <Heading color={"#8000ff"} title={"Key Skills"} />
          ...
          <div>
            <Heading color={"#8000ff"} title={"Achievements"} />
            <ul style={{ marginBottom: 10 }}>
          ...
          <div>
            <Heading color={"#8000ff"} title={"Projects"} />
            <ul style={{ marginBottom: 10 }}>
