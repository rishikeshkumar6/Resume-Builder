...
const AboutUs = () => {
  return (
    <div>
      <Stack padding={
        { lg: '30px', md: '30px', sm: '25px', sx: '15px' }
      }>
        ...
        <Box className='icons'>
          <a href="https://web.whatsapp.com/" target='_blank' rel="noopener noreferrer">
            <WhatsApp className='WhatsApp' sx={{ fontSize: "35px", margin: 1 }}></WhatsApp></a>
          <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
            <Facebook className='Facebook' sx={{ fontSize: "35px", margin: 1 }}></Facebook></a>
          <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer">
            <LinkedIn className='LinkedIn' sx={{ fontSize: "35px", margin: 1 }}></LinkedIn></a>
          <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">
            <Instagram className='Instagram' sx={{ fontSize: "35px", margin: 1 }}></Instagram></a>
          <a href="https://mail.google.com/" target="_blank" rel="noopener noreferrer">
            <Email className='Email' sx={{ fontSize: "35px", margin: 1 }}></Email></a>
          <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer">
            <Twitter className='Twitter' sx={{ fontSize: "35px", margin: 1 }}></Twitter></a>
          <a href="https://www.reddit.com/" target="_blank" rel="noopener noreferrer">
            <Reddit className='Reddit' sx={{ fontSize: "35px", margin: 1 }}></Reddit></a>
